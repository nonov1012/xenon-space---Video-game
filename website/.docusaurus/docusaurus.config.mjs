...
export default {
  ...
  "organizationName": "nonov1012",
  "projectName": "xenon-space---Video-game",
  "onBrokenLinks": "warn",
  "i18n": {
    "defaultLocale": "fr",
    "locales": [
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/nonov1012/xenon-space---Video-game/tree/main/website/"
        },
        "blog": false,
        "theme": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Xenon Space Team. Construit avec Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
