...
Elle agrège les classes [`BarDisplay`](./2-BarDisplay.md) et [`TurnDisplay`](./3-TurnDisplay.md).
...
| :--- | :--- | :--- |
| `left_bar` | [`BarDisplay`](./2-BarDisplay.md) | Barre d'état affichant les informations du **Joueur 0**. |
| `right_bar` | [`BarDisplay`](./2-BarDisplay.md) | Barre d'état affichant les informations du **Joueur 1**. |
| `turn_display` | [`TurnDisplay`](./3-TurnDisplay.md) | Panneau d'affichage du tour en cours. |
...
Initialise les composants du HUD en créant les instances de [`BarDisplay`](./2-BarDisplay.md) et [`TurnDisplay`](./3-TurnDisplay.md). Cette méthode doit être appelée **une seule fois** au démarrage du jeu.
